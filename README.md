# Entrust Identity Verification SDK for iOS

The **Entrust Identity Verification SDK for iOS** (formerly the Onfido iOS Smart Capture SDK) provides a set of screens and modules that enable applications to implement user identity verification flows.
...
For a breakdown of the SDK's size impact per module, see the [size.md](size.md) report.
